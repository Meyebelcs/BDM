    ...
    <div class="swiper-wrapper">
        ...
        ?>
                <div class="card swiper-slide" style="width: 23rem;">
                    <img src="data:image/jpeg;base64,<?php echo base64_encode($producto->getImagen()); ?>" class="card-img-top" alt="<?php echo $producto->getNombre(); ?>">
                    <div class="card-body">
                        <h4 class="card-title mb-0"><?php echo $producto->getNombre(); ?></h4>
              ...
              foreach ($categoriasbyproduct as $category) { ?>
                  <small class="card-text mb-1">
                      <strong>#<?php echo $category->getNombre(); ?></strong>
                  </small>
              <?php } ?>
              <hr class="mt-2">
              <p class="card-text mb-1">Precio: $<?php echo $producto->getPrecio(); ?></p>
              <p class="card-text mb-1">Cantidad Vendida: <?php echo $producto->getCantidadVendida(); ?></p>
              <p class="card-text mb-1">Inventario: <?php echo $producto->getInventario(); ?></p>
              <p class="card-text mb-1">Total de Ingresos: $<?php echo $producto->getTotalIngresos(); ?></p>
              <p class="card-text mb-1">Fecha de publicación: <?php echo $producto->getFecha(); ?></p>
              <p class="card-text mb-1">Hora de publicación: <?php echo $producto->getHora(); ?></p>
              ...
              <a href="Detalle_producto.php?idProductoIndex=<?php echo $producto->getIdProducto(); ?>" class="btn btn-secondary mb-1" id="">Ver detalles</a>
...
<div class="swiper-wrapper">
  ...
  ?>
          <div class="card swiper-slide" style="width: 23rem;">
              <img src="data:image/jpeg;base64,<?php echo base64_encode($Cotizacion->getImagen()); ?>" class="card-img-top" alt="<?php echo $producto->getNombre(); ?>">
              <div class="card-body">
                  <h4 class="card-title mb-0"><?php echo $Cotizacion->getNombre(); ?></h4>
                  <!-- Resto de tus datos dinámicos del producto -->
        <small class="card-text mb-1">
