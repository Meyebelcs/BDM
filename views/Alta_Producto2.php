    ...
    <main m-0 p-0 class="background">
        ...
        <div class="container">
                        ...
                        <div class="wrapper">
                            <div class="box">
                                <div class="input-bx d-flex flex-column align-items-center">
                                    ...
                                    <input type="file" id="imagenStock" class="form-control mt-3">
            ...
            <div class="productosCotizacion">
                ...
                <form id="formCotizacion" action="" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="text-center">
                        <input type="submit" class="add btn btn-orange " value="Agregar Cotización">
                    </div>
                </form>
            </div>
        </div>
